    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='recognize.car')),
                ('parking_number', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parking_area.parkingspace')),
                ('tarif', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='finance.pricing')),
            ],
        ),
    ]
